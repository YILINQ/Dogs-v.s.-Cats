...
training_set = train_datagen.flow_from_directory('dataset/dog/train', target_size = (64, 64), batch_size = 32, class_mode = 'categorical')
test_set = test_datagen.flow_from_directory('dataset/dog/test', target_size = (64, 64), batch_size = 32, class_mode = 'categorical')
